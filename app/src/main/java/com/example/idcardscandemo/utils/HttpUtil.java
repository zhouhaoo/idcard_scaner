package com.example.idcardscandemo.utils;
...
public class HttpUtil {
		...
		public static final String USERNAME="b4422eff-ebc8-47c7-bab0-607ee293c6d9";//开发者平台API帐号
		public static final String PASSWORD="tZgbgLQBrMMJyBSweKsXmvEpZWhbgy";//开发者平台API密码
